 ...
 (function($) {
	...
	$.fn.jTPS = function ( opt ) {
		...
		$(this).data('tableSettings', $.extend({
			perPages:			[5, 6, 10, 20, 50, 'Todos'],				// the "show per page" selection
			perPageText:		'Mostrar por pagina: ',						// text that appears before perPages links
			...
			scrollDelay:		30,										// delay (in ms) between steps in anim. - IE has trouble Mostrando animation with < 30ms delay
