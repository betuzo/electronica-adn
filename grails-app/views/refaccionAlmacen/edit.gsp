...
<html>
	...
	<body>
		<a href="#edit-refaccionAlmacen" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-refaccionAlmacen" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${refaccionAlmacenInstance?.version}" />
				<fieldset class="form">
