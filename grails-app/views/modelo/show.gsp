	...
	<body>
		...
		<div id="show-modelo" class="content scaffold-show" role="main">
			...
			<ol class="property-list modelo">
				...
				<g:if test="${modeloInstance?.nombreModelo}">
				<li class="fieldcontain">
					<span id="nombreModelo-label" class="property-label"><g:message code="modelo.nombreModelo.label" default="Nombre Modelo" /></span>
					
						<span class="property-value" aria-labelledby="nombreModelo-label"><g:fieldValue bean="${modeloInstance}" field="nombreModelo"/></span>
