			...
			<table id="tableGrid">
				<thead>
					<tr>
						...
						<g:sortableColumn property="nombreModelo" title="${message(code: 'modelo.nombreModelo.label', default: 'Nombre Modelo')}" />
				...
				<g:each in="${modeloInstanceList}" status="i" var="modeloInstance">
					<tr>
						...
						<td><g:link action="show" id="${modeloInstance.id}">${fieldValue(bean: modeloInstance, field: "nombreModelo")}</g:link></td>
