			...
			<ol class="property-list entrada">
				...
				<li class="fieldcontain">
					<span id="pagos-label" class="property-label"><g:message code="entrada.pagos.label" default="Pagos" /></span>
						&nbsp; &nbsp; &nbsp;Agregar Pagos <img id="slide-fecha-open" href="#" src="${resource(dir: 'images', file: 'Writing.png')}" alt="Agregar fecha" height="30px" width="30px"/>
						...
						<span class="property-value" aria-labelledby="pagos-label">
							...
							<img id="delete-pagos" href="#"src="${resource(dir: 'images', file: 'Recycle-Closed.png')}" alt="Eliminar Pago" height="20px" width="20px"/>
						</span>
						</g:each>
				...
				<g:if test="${entradaInstance?.refacciones}">
					<li class="fieldcontain">
						...
						&nbsp; &nbsp; &nbsp;Agregar refacciones<img id="slide-fecha-open" href="#" src="${resource(dir: 'images', file: 'Writing.png')}" alt="Agregar fecha" height="30px" width="30px"/>
