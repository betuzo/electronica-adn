...
<html>
	...
	<body>
		<a href="#edit-contactoProveedor" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-contactoProveedor" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${contactoProveedorInstance?.version}" />
				<fieldset class="form">
