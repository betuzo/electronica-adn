	...
	<body>
		...
		<div id="show-marca" class="content scaffold-show" role="main">
			...
			<ol class="property-list marca">
				...
				<g:if test="${marcaInstance?.nombreMarca}">
				<li class="fieldcontain">
					<span id="nombreMarca-label" class="property-label"><g:message code="marca.nombreMarca.label" default="Nombre Marca" /></span>
					
						<span class="property-value" aria-labelledby="nombreMarca-label"><g:fieldValue bean="${marcaInstance}" field="nombreMarca"/></span>
